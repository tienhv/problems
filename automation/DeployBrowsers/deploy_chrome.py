...
def deploy_chrome(browser_params):
    ...
    if browser_params["socks"]:
        ...
        #fp.set_preference("network.proxy.socks_port",browser_params["socks_port"])
        proxy = 'socks5://' + browser_params["socks"] + ":" + browser_params["socks_port"]
        co.add_argument("--proxy-server="+proxy)
    #======== End socks proxy ===================================
